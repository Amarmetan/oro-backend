 ...
 * If running in companion applet simulator, allows selecting test persona via 'x-mock-user-id'.
 * Enforces RBAC by strictly preserving is_admin from database and admin whitelist.
 */
...
/**
 * POST /api/upload
 * Handles direct screenshot file upload or media teaser/poster file upload
 */
